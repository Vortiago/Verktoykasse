...
Consulted from steps 4–5 of `SKILL.md`. Two parts: the catalogue of tests that *look* like guards but are not, and the mutation recipe that proves a guard is real.
