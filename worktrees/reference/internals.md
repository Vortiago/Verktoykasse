...
files, for example a local config the app needs to boot:
...
(mirroring the worktree layout). Every new worktree gets them, with nothing in
git history and no dependence on the source worktree:
